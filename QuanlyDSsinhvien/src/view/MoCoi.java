 ...
 * @author Admin
 */
public class MoCoi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mồ côi ", "Dân tộc thiểu số  ", "Khuyết tật", "Con Thương binh liệt sĩ", "Hộ cận nghèo", "Hộ nghèo", "Con Cb,Cn,Vc tai nạn lao động", "Hoàn cảnh khó khắn", " " }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MoCoi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
