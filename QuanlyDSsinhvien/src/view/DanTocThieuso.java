 ...
 * @author Admin
 */
public class DanTocThieuso extends javax.swing.JFrame {

    /**
     * Creates new form HoNgheo
     */
    public DanTocThieuso() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Dân tộc thiểu số  ", "Khuyết tật", "Con Thương binh liệt sĩ", "Hộ cận nghèo", "Hộ nghèo", "Mồ côi ", "Con Cb,Cn,Vc tai nạn lao động", "Hoàn cảnh khó khắn", " " }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DanTocThieuso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
