 ...
 * @author Admin
 */
public class ThuongBinh extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Con Thương binh liệt sĩ", "Hộ cận nghèo", "Hộ nghèo", "Mồ côi ", "Con Cb,Cn,Vc tai nạn lao động", "Khuyết tật", "Hoàn cảnh khó khắn", "Dân tộc thiểu số  " }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThuongBinh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
